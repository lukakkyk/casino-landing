...
function TouchableOpacityImpl(props, forwardedRef) {
  const {
    ...
    setOpacityTo = useCallback((value, duration2) => {
      setOpacityOverride(value), setDuration(duration2 ? `${duration2 / 1e3}s` : "0s");
    }, [setOpacityOverride, setDuration]),
    setOpacityActive = useCallback(duration2 => {
      setOpacityTo(activeOpacity ?? 0.2, duration2);
    }, [activeOpacity, setOpacityTo]),
    setOpacityInactive = useCallback(duration2 => {
...
//# sourceMappingURL=TouchableOpacity.mjs.map
