import { _EventSubscription } from "./_EventSubscription.mjs";
...
export { EmitterSubscription, EmitterSubscription_default as default };
//# sourceMappingURL=_EmitterSubscription.mjs.map
