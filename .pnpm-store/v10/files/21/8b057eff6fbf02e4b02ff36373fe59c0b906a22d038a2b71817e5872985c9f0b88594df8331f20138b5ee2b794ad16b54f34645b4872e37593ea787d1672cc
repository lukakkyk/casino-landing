...
var import_react_dom = require("react-dom"),
  ...
  import_renderApplication = require("./renderApplication.cjs");
const emptyObject = {},
  runnables = {};
...
class AppRegistry {
  ...
  static getApplication(appKey, appParameters) {
    return (0, import_react_native_web_internals.invariant)(runnables[appKey] && runnables[appKey].getApplication, `Application ${appKey} has not been registered. This is either due to an import error during initialization or failure to call AppRegistry.registerComponent.`), runnables[appKey]?.getApplication?.(appParameters);
  }
