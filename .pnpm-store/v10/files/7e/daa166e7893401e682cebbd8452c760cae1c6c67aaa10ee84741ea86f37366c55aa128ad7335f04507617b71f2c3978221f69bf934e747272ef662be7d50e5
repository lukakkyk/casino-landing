...
import { TextInputState, forwardedProps, getLocaleDirection, pick, useElementLayout, useLocaleContext, useMergeRefs, usePlatformMethods, useResponderEvents } from "@tamagui/react-native-web-internals";
...
const isSelectionStale = (node, selection) => {
  ...
  pickProps = props => pick(props, forwardPropsList),
