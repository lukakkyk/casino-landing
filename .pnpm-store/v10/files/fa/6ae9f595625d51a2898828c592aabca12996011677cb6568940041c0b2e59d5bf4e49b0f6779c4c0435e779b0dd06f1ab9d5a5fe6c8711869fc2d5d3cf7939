...
function useSheetProviderProps(props, state, options = {}) {
  const handleRef = import_react.default.useRef(null),
    ...
    snapPoints = import_react.default.useMemo(() => props.dismissOnSnapToBottom ? [...snapPointsProp, 0] : snapPointsProp, [JSON.stringify(snapPointsProp), props.dismissOnSnapToBottom]),
    ...
    setPosition = import_react.default.useCallback(next => {
