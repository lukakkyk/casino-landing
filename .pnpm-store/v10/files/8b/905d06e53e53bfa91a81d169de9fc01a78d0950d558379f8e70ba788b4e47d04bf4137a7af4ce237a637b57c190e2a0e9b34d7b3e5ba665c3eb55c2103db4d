...
__export(StateSafePureComponent_exports, {
  StateSafePureComponent: () => StateSafePureComponent,
  default: () => StateSafePureComponent_default
});
...
class StateSafePureComponent extends React.PureComponent {
  ...
  _installSetStateHooks() {
    ...
    Object.defineProperty(this, "props", {
      ...
      get() {
        return (0, import_react_native_web_internals.invariant)(!that._inAsyncStateUpdate, '"this.state" should not be acceessed during state updates'), state;
      },
      set(newState) {
        state = newState;
      }
