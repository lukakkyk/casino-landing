...
const EMPTY = {},
  ...
  useThemeWithState = (props, isRoot = !1) => {
    ...
    const keys = (0, import_react.useRef)(null),
      schemeKeys = (0, import_react.useRef)(null),
      themeState = (0, import_useThemeState.useThemeState)(props, isRoot, keys, schemeKeys);
...
If this is intended and you are using Tamagui without any themes, you can disable this warning by setting the environment variable TAMAGUI_DISABLE_NO_THEME_WARNING=1`), [props.passThrough ? {} : (0, import_getThemeProxied.getThemeProxied)(props, themeState, keys, schemeKeys), themeState];
  };