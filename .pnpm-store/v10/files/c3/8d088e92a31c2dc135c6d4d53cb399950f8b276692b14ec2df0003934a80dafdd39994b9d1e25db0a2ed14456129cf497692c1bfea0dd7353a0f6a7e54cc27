...
var import_jsx_runtime = require("react/jsx-runtime"),
  ...
  import_eventHandling = require("./eventHandling.native.js"),
  import_getDefaultProps = require("./helpers/getDefaultProps.native.js"),
  ...
  import_mergeProps = require("./helpers/mergeProps.native.js"),
  import_mergeRenderElementProps = require("./helpers/mergeRenderElementProps.native.js"),
  import_objectIdentityKey = require("./helpers/objectIdentityKey.native.js"),
  import_pointerEvents = require("./helpers/pointerEvents.native.js"),
  import_pseudoTransitions = require("./helpers/pseudoTransitions.native.js"),
  import_setElementProps = require("./helpers/setElementProps.native.js"),
  import_subscribeToContextGroup = require("./helpers/subscribeToContextGroup.native.js"),
  import_themeable = require("./helpers/themeable.native.js"),
  import_wrapStyleTags = require("./helpers/wrapStyleTags.native.js"),
  import_useComponentState = require("./hooks/useComponentState.native.js"),
  import_useMedia = require("./hooks/useMedia.native.js"),
  import_useTheme = require("./hooks/useTheme.native.js"),
  import_setupHooks = require("./setupHooks.native.js"),
  import_Slot = require("./views/Slot.native.js"),
...
function createComponent(staticConfig) {
  var config = null,
    ...
    component = /* @__PURE__ */import_react.default.forwardRef(function (propsIn, forwardedRef) {
      "use no memo";
      ...
      var {
        ...
        isInsideNativeMenu = import_react.default.useContext(import_native.NativeMenuContext);
      ...
      props = nextProps, overriddenContextProps = overrides, process.env.NODE_ENV === "development" && import_constants.isClient && import_react.default.useEffect(function () {
        var node,
          overlay = null,
          remove = function () {
            if (overlay) try {
      ...
      var groupContextParent = import_react.default.useContext(import_GroupContext.GroupContext),
        animationDriver = function () {
          ...
          return (_ref = (_resolveAnimationDriver = (0, import_resolveAnimationDriver.resolveAnimationDriver)(componentContext.animationDriver)) !== null && _resolveAnimationDriver !== void 0 ? _resolveAnimationDriver : (0, import_resolveAnimationDriver.resolveAnimationDriver)(config?.animations)) !== null && _ref !== void 0 ? _ref : null;
        }(),
      ...
      hasAnimationProp && animationDriver?.avoidReRenders && (0, import_constants.useIsomorphicLayoutEffect)(function () {
      ...
      var renderProp = props.render,
        ...
        element = import_constants.isWeb && isRenderString && renderProp || Component,
      ...
      if (!isPassthrough && (hasAnimationProp || groupName) && animationDriver?.avoidReRenders && !hasEnterExitTransition) {
        ...
        if (stateRef.current.updateStyleListener = function () {
          ...
          var updatedState = stateRef.current.nextState || state,
            ...
            effectiveTransition2 = (0, import_pseudoTransitions.resolveEffectivePseudoTransition)(stateRef.current.prevPseudoState, updatedState, nextStyles?.pseudoTransitions, props.transition);
          stateRef.current.prevPseudoState = (0, import_pseudoTransitions.extractPseudoState)(updatedState), useStyleListener(nextStyles?.style || {}, effectiveTransition2);
...
` && console.error(`Unexpected text node: ${item}. A text node cannot be a child of a <${staticConfig.componentName || propsIn.tag || "View"}>.`, props);
      ...
      }, [state.unmounted, inputStyle]), (0, import_constants.useIsomorphicLayoutEffect)(function () {
      ...
      var events = shouldAttach ? {
        ...
        onPress: attachPress ? function (e) {
          unPress(), import_constants.isWeb && onClick?.(e), onPress?.(e);
        } : void 0,
      ...
      var pressGesture = (0, import_eventHandling.useEvents)(events, viewProps, stateRef, staticConfig, isHOC, isInsideNativeMenu);
      if (process.env.NODE_ENV === "development" && time && time`hooks`, asChild) if (elementType = import_Slot.Slot, 0) var webStyleEvents, passEvents;else Object.assign(viewProps, {
        onPress,
        onLongPress
      });
      ...
      if (isPassthrough) content = /* @__PURE__ */import_react.default.createElement(BaseComponent, {
        ...
        content || (isRenderPropString && viewProps.render, content = /* @__PURE__ */import_react.default.createElement(elementType, viewProps, content || children)), process.env.NODE_ENV === "development" && time && time`use-children`;
      }
      ...
      if (renderReset && ResetPresence && (content = /* @__PURE__ */(0, import_jsx_runtime.jsx)(ResetPresence, {
        disabled: !needsReset,
        children: content
        ...
        children: content
      })), process.env.NODE_ENV === "development" && time && time`group-context`, content = disableTheme || !splitStyles ? content : (0, import_Theme.getThemedChildren)(themeState, content, themeStateProps, !1, stateRef), process.env.NODE_ENV === "development" && time && time`themed-children`, overriddenContextProps && contextForOverride) {
  ...
  var res = component;
  res = /* @__PURE__ */import_react.default.memo(res), res.staticConfig = staticConfig;
  ...
  function styleable(Component2, options) {
    var skipForwardRef = typeof Component2 == "function" && Component2.length === 1,
      out = skipForwardRef ? Component2 : /* @__PURE__ */import_react.default.forwardRef(Component2),
      extendedConfig = extendStyledConfig(options?.staticConfig);
    return out = options?.disableTheme ? out : (0, import_themeable.themeable)(out, extendedConfig, !0), (extendedConfig.memo || process.env.TAMAGUI_MEMOIZE_STYLEABLE) && (out = /* @__PURE__ */import_react.default.memo(out)), out.staticConfig = extendedConfig, out.styleable = styleable, out;
  }
...
var fromPx = function (val) {
  ...
  getCustomRender = function (renderProp, content, viewProps, state) {
    ...
    if (renderProp && (typeof renderProp > "u" ? "undefined" : _type_of(renderProp)) === "object" && /* @__PURE__ */import_react.default.isValidElement(renderProp)) {
