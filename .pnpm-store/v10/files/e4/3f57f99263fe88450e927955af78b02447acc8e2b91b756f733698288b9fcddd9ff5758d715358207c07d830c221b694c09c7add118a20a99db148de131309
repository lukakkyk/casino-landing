...
class AnimatedMultiplication extends AnimatedWithChildren {
  ...
  _b;
  constructor(a, b) {
    super(), this._a = typeof a == "number" ? new AnimatedValue(a) : a, this._b = typeof b == "number" ? new AnimatedValue(b) : b;
  }
...
export { AnimatedMultiplication, AnimatedMultiplication_default as default };
//# sourceMappingURL=AnimatedMultiplication.mjs.map
