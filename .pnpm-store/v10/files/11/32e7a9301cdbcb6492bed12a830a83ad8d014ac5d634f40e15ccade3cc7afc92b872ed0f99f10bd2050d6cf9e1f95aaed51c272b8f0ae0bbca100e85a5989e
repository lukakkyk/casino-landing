...
const Image = React.forwardRef((props, ref) => {
  ...
  const [state, updateState] = React.useState(() => {
    ...
    hiddenImage = displayImageUri ? (0, import_createElement.createElement)("img", {
  ...
  }, [uri, requestRef, updateState, onError, onLoad, onLoadEnd, onLoadStart]), /* @__PURE__ */(0, import_jsx_runtime.jsxs)(import_View.View, {
    ...rest,
