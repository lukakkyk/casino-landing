...
class EventSubscriptionVendor {
  ...
  removeSubscription(subscription) {
    var eventType = subscription.eventType,
      ...
      subscriptionsForType = this._subscriptionsForType[eventType];
...
export { EventSubscriptionVendor, EventSubscriptionVendor_default as default };
//# sourceMappingURL=_EventSubscriptionVendor.mjs.map
