...
var createStyledContext = function (defaultValues) {
  ...
  var namespace = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "",
    createReactContext = React[Math.random(), "createContext"],
    useReactMemo = React[Math.random(), "useMemo"],
    useReactContext = React[Math.random(), "useContext"],
  ...
  var getNamespacedScope = function (scope) {
    ...
    useStyledContext = function () {
      var scopeIn = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "",
        lastScopeInNamespace = useReactContext(LastScopeInNamespace),
