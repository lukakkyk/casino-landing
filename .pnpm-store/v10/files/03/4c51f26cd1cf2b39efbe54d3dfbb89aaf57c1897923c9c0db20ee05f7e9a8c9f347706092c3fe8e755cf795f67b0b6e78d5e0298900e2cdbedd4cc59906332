...
var import_jsx_runtime = require("react/jsx-runtime"),
  ...
  import_Tabs = require("./Tabs.native.js");
  ...
  var TRIGGER_NAME = "TabsTrigger",
    TabsTrigger = TabFrame.styleable(function (props, forwardedRef) {
      ...
      React.useEffect(function () {
        ...
        return observer.observe(el), function () {
      ...
      return /* @__PURE__ */(0, import_jsx_runtime.jsx)(import_roving_focus.RovingFocusGroup.Item, {
        ...
        children: /* @__PURE__ */(0, import_jsx_runtime.jsx)(TabFrame, {
          ...
          onMouseEnter: (0, import_helpers.composeEventHandlers)(props.onMouseEnter, function () {
            layout && onInteraction?.("hover", layout);
          }),
          onMouseLeave: (0, import_helpers.composeEventHandlers)(props.onMouseLeave, function () {
          ...
          ...(import_constants.isWeb && {
            ...
            onBlur: (0, import_helpers.composeEventHandlers)(props.onBlur, function () {
  ...
  var TabsContent = ContentFrame.styleable(function (props, forwardedRef) {
    ...
    TabsComponent = TabsFrame.styleable(function (props, forwardedRef) {
      var {
        ...
        registerTrigger = (0, import_web.useEvent)(function () {
