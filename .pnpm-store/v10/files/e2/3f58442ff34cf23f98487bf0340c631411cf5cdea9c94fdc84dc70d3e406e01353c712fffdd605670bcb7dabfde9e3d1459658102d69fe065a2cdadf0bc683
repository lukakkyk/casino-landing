import { NativeAnimatedNonTurboModule } from "./NativeAnimatedModule.mjs";
import { NativeAnimatedTurboModule } from "./NativeAnimatedTurboModule.mjs";
import { NativeEventEmitter } from "../EventEmitter/NativeEventEmitter.mjs";
import { Platform } from "../Utilities/Platform.mjs";
import { ReactNativeFeatureFlags } from "../ReactNative/ReactNativeFeatureFlags.mjs";
import { invariant } from "@tamagui/react-native-web-internals";
import { RCTDeviceEventEmitter } from "../EventEmitter/RCTDeviceEventEmitter.mjs";
const NativeAnimatedModule = Platform.OS === "ios" && global.RN$Bridgeless === !0 ? NativeAnimatedTurboModule : NativeAnimatedNonTurboModule;
