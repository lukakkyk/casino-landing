...
var import_canUseDOM = require("../canUseDOM.cjs"),
  import_createEventHandle = require("../createEventHandle/index.cjs");
...
const listeners = /* @__PURE__ */new Set(),
  ...
  addBlurListener = (0, import_createEventHandle.createEventHandle)(BLUR, bubbleOptions),
  addFocusListener = (0, import_createEventHandle.createEventHandle)(FOCUS, bubbleOptions),
  addVisibilityChangeListener = (0, import_createEventHandle.createEventHandle)(VISIBILITYCHANGE, captureOptions),
  addKeyDownListener = (0, import_createEventHandle.createEventHandle)(KEYDOWN, captureOptions),
  addPointerDownListener = (0, import_createEventHandle.createEventHandle)(POINTERDOWN, captureOptions),
  addPointerMoveListener = (0, import_createEventHandle.createEventHandle)(POINTERMOVE, captureOptions),
  addContextMenuListener = (0, import_createEventHandle.createEventHandle)(CONTEXTMENU, captureOptions),
  addMouseDownListener = (0, import_createEventHandle.createEventHandle)(MOUSEDOWN, captureOptions),
  addMouseMoveListener = (0, import_createEventHandle.createEventHandle)(MOUSEMOVE, captureOptions),
  addMouseUpListener = (0, import_createEventHandle.createEventHandle)(MOUSEUP, captureOptions),
  addScrollListener = (0, import_createEventHandle.createEventHandle)(SCROLL, captureOptions),
  addSelectiomChangeListener = (0, import_createEventHandle.createEventHandle)(SELECTIONCHANGE, captureOptions),
  addTouchCancelListener = (0, import_createEventHandle.createEventHandle)(TOUCHCANCEL, captureOptions),
  addTouchMoveListener = (0, import_createEventHandle.createEventHandle)(TOUCHMOVE, captureOptions),
  addTouchStartListener = (0, import_createEventHandle.createEventHandle)(TOUCHSTART, captureOptions);
