...
import { arrow, flip, getOverflowAncestors, offset as offsetFn, platform, shift, useFloating } from "@tamagui/floating";
...
function tamaguiAutoUpdate(reference, floating, update) {
  ...
  _instanceof(reference, HTMLElement) && cleanups.push(registerLayoutNode(reference, update));
  var refAncestors = _instanceof(reference, Element) ? getOverflowAncestors(reference) : [],
    ancestors = [...refAncestors, ...getOverflowAncestors(floating)],
...
function Popper(props) {
  ...
  return /* @__PURE__ */_jsx(PopperProvider, {
    ...
    /* @__PURE__ */
    _jsx(FloatingOverrideContext.Provider, {
      value: null,
      children
    }))
  });
