...
var import_theme_builder = require("@tamagui/theme-builder"),
  ...
  getBaseTemplates = function (scheme) {
    var isLight = scheme === "light",
      ...
      color = -background,
      makeSurface = function (offset) {
        var colorOffset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0,
          clr = color - colorOffset,
      ...
      accent = Object.fromEntries(Object.entries(base).map(function (param) {
        var [key, index] = param;
        return [key, -index];
      }));
    return {
