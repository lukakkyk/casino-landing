...
var useComponentState = function (props, animationDriver, staticConfig, config) {
  ...
  if (!isHydrated) noClass = !1;else if (isWeb && isHydrated) {
    var isAnimatedAndHydrated = isAnimated && isHydrated,
      isClassNameDisabled = !staticConfig.acceptsClassName && (getSetting("disableSSR") || !state.unmounted),
    ...
    (isAnimatedAndHydrated && outputStyle !== "css" || isDisabledManually || isClassNameDisabled) && (noClass = !0, process.env.NODE_ENV === "development" && props.debug === "verbose" && log("avoiding className", {
