...
function evaluateRenderProp(render, props, state, defaultElement) {
  ...
  if (typeof render == "string") return render[0] === render[0].toLowerCase() ? defaultElement : /* @__PURE__ */createElement(render, props, defaultChildren);
