...
var import_helpers = require("@tamagui/helpers"),
  ...
  import_normalizeColor = require("./normalizeColor.native.js"),
  fontShorthand = {
    fontSize: "size",
    fontWeight: "weight"
  },
  didLogMissingToken = !1,
  colorKeys = import_helpers.tokenCategories.color,
...
var getTokenForKey = function (key, value, styleProps, styleState) {
  ...
  if (customTokenAccept) {
    var _tokensParsed_customTokenAccept,
      val = themeValue ?? ((_tokensParsed_customTokenAccept = tokensParsed[customTokenAccept]) === null || _tokensParsed_customTokenAccept === void 0 ? void 0 : _tokensParsed_customTokenAccept[value]);
        ...
        case "fontFamily":
          {
            ...
            valOrVar = ((_fontsParsed_value = fontsParsed[value]) === null || _fontsParsed_value === void 0 ? void 0 : _fontsParsed_value.family) || value, setLastFontFamilyToken(value), hasSet = !0;
            break;
          }
        case "fontSize":
        case "lineHeight":
