...
var import_helpers = require("@tamagui/helpers"),
  ...
  import_mainThreadPressEvents = require("./helpers/mainThreadPressEvents.native.js");
...
function useEvents(events, viewProps, stateRef, staticConfig, isHOC, isInsideNativeMenu) {
  ...
  var hasPressEvents = events?.onPress,
    gh = (0, import_native.getGestureHandler)();
  ...
  if (staticConfig.isInput) {
    if (events) {
      ...
      onPressOut && onPress && (inputEvents.onPressOut = (0, import_helpers.composeEventHandlers)(onPress, onPressOut)), Object.assign(viewProps, inputEvents);
    }
    return null;
  }
  ...
  if (isUsingRNGH) {
    var callbacksRef = (0, import_react.useRef)(isUsingRNGH ? {} : null),
      gestureRef = (0, import_react.useRef)(null);
    if (everEnabled) {
  ...
  return (0, import_mainThreadPressEvents.useMainThreadPressEvents)(events, viewProps, hasPressEvents), null;
}
function wrapWithGestureDetector(content, gesture, stateRef, isHOC, isCompositeComponent) {
  ...
  return gestureToUse ? import_react.default.createElement(GestureDetector, {
