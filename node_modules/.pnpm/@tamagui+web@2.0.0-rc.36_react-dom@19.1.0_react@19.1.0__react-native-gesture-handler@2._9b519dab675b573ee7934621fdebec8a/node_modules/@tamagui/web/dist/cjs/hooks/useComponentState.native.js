...
var useComponentState = function (props, animationDriver, staticConfig, config) {
  ...
  var hasAnimationProp = !!(!isHOC && "transition" in props || props.style && hasAnimatedStyleValue(props.style)),
    _animationDriver_inputStyle,
    inputStyle = (_animationDriver_inputStyle = animationDriver?.inputStyle) !== null && _animationDriver_inputStyle !== void 0 ? _animationDriver_inputStyle : "css",
    _animationDriver_outputStyle,
    outputStyle = (_animationDriver_outputStyle = animationDriver?.outputStyle) !== null && _animationDriver_outputStyle !== void 0 ? _animationDriver_outputStyle : "css",
  ...
  var {
    ...
    hasAnimationThatNeedsHydrate = hasAnimationProp && !isHydrated && (animationDriver?.isReactNative || inputStyle !== "css"),
  ...
  if (!isHydrated) noClass = !1;else if (import_constants.isWeb && isHydrated) {
    var isAnimatedAndHydrated = isAnimated && isHydrated,
      isClassNameDisabled = !staticConfig.acceptsClassName && ((0, import_config.getSetting)("disableSSR") || !state.unmounted),
    ...
    (isAnimatedAndHydrated && outputStyle !== "css" || isDisabledManually || isClassNameDisabled) && (noClass = !0, process.env.NODE_ENV === "development" && props.debug === "verbose" && (0, import_log.log)("avoiding className", {
