...
const getTokenForKey = (key, value, styleProps, styleState) => {
  ...
  if (hasSet) {
    ...
    return opacityModifier !== void 0 && opacityModifier < 1 && (out = (0, import_normalizeColor.normalizeColor)(String(out), opacityModifier) ?? out), process.env.NODE_ENV === "development" && styleState.debug === "verbose" && (globalThis.tamaguiAvoidTracking = !0, console.info("resolved", resolveAs, valOrVar, out), globalThis.tamaguiAvoidTracking = !1), out;
  }
