...
var import_constants = require("@tamagui/constants"),
  ...
  import_constants3 = require("../constants/constants.native.js"),
  ...
  cacheVersion = 0,
  themeNameCache = /* @__PURE__ */new Map(),
  themeNameCacheVer = -1,
  themes = null,
  rootThemeState = null,
    ...
    var id = (0, import_react.useId)(),
      ...
      getSnapshot = function () {
        ...
        var isSchemeOnlyChange = import_constants.isIos && (0, import_config.getSetting)("fastSchemeChange") && local && parentState && local.scheme !== parentState.scheme && getThemeBaseName(local.name) === getThemeBaseName(parentState.name),
          _keys_current_size,
          keysSize = (_keys_current_size = keys == null || (_keys_current = keys.current) === null || _keys_current === void 0 ? void 0 : _keys_current.size) !== null && _keys_current_size !== void 0 ? _keys_current_size : 0,
          _schemeKeys_current_size,
          schemeKeysSize = (_schemeKeys_current_size = schemeKeys == null || (_schemeKeys_current = schemeKeys.current) === null || _schemeKeys_current === void 0 ? void 0 : _schemeKeys_current.size) !== null && _schemeKeys_current_size !== void 0 ? _schemeKeys_current_size : 0,
...
function getNewThemeName() {
  ...
  if (reset) {
    ...
    var lastPartIndex = parentName.lastIndexOf("_"),
      ...
      result1 = themes2[name1] ? name1 : scheme;
        ...
        try {
          outer: for (var _iterator1 = potentialBases[Symbol.iterator](), _step1; !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion1 = !0) {
            var base = _step1.value,
              candidates = [componentName ? `${base}_${name}_${componentName}` : void 0, `${base}_${name}`].filter(Boolean),
    ...
    try {
      for (var _iterator3 = subNames[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = !0) {
        var subName1 = _step3.value,
          potential2 = base1 ? `${base1}_${subName1}` : subName1;
