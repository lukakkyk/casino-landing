...
var import_react_native_web_internals = require("@tamagui/react-native-web-internals"),
  import_EventEmitter = __toESM(require("../vendor/react-native/emitter/_EventEmitter.cjs"), 1),
  import_TaskQueue = require("./TaskQueue.cjs"),
  import_requestIdleCallback = require("../modules/requestIdleCallback.cjs");
const _emitter = new import_EventEmitter.default(),
  ...
  _taskQueue = new import_TaskQueue.TaskQueue({
