...
class ScrollView extends React.Component {
  ...
  render() {
    ...
    const hasStickyHeaderIndices = !horizontal && Array.isArray(stickyHeaderIndices),
      children = hasStickyHeaderIndices || pagingEnabled ? React.Children.map(this.props.children, (child, i) => {
        const isSticky = hasStickyHeaderIndices && stickyHeaderIndices.indexOf(i) > -1;
        return child != null && (isSticky || pagingEnabled) ? /* @__PURE__ */jsx(View, {
          style: StyleSheet.compose(isSticky && styles.stickyHeader, pagingEnabled && styles.pagingEnabledChild),
          children: child
        }) : child;
      }) : this.props.children,
      contentContainer = /* @__PURE__ */jsx(View, {
    ...
    const scrollView = /* @__PURE__ */jsx(ScrollViewClass, {
      ...props,
...
const commonStyle = {
  ...
  ForwardedScrollView = React.forwardRef((props, forwardedRef) => /* @__PURE__ */jsx(ScrollView, {
    ...props,
    forwardedRef
  }));
ForwardedScrollView.displayName = "ScrollView";
var ScrollView_default = ForwardedScrollView;
export { ForwardedScrollView as ScrollView, ScrollView_default as default };
