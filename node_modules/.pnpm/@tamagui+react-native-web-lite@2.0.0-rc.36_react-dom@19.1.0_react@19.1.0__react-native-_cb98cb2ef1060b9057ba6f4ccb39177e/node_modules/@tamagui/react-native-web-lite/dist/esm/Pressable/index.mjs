...
const styles = StyleSheet.create({
  ...
  PressableComponent = memo(forwardRef(Pressable));
PressableComponent.displayName = "Pressable";
var Pressable_default = PressableComponent;
export { PressableComponent as Pressable, Pressable_default as default };
