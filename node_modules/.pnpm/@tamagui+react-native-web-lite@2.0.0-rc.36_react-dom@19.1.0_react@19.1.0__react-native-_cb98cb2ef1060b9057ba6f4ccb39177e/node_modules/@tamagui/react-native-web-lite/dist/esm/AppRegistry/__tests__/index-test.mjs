...
describe("AppRegistry", () => {
  describe("runApplication", () => {
    ...
    beforeEach(() => {
      ...
      AppRegistry.registerComponent("App", () => NoopComponent), AppRegistry.runApplication("App", {
        initialProps: {},
        rootTag,
        callback
      ...
      iframeRootTag.id = "react-iframe-root", iframe.contentWindow.document.body.appendChild(iframeRootTag), AppRegistry.registerComponent("App", () => NoopComponent), AppRegistry.runApplication("App", {
        initialProps: {},
