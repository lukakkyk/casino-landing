...
function useAnimateSSRSafe() {
  return isServer ? [useRef(null), function () {}] : useAnimate();
}
...
function createAnimations(animations) {
  ...
  return {
    ...
    useAnimations: function (animationProps) {
      ...
      (justStartedExiting || justStoppedExiting) && (refs.current.frozenExitTarget = null, refs.current.exitCompleteScheduled = !1), useEffect(function () {
    ...
    useAnimatedNumber(initial) {
      var motionValue = useMotionValue(initial);
