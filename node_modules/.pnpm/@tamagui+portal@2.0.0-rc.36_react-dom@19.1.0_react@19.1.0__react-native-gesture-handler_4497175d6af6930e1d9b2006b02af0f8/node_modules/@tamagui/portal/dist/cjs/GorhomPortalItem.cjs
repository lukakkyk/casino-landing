...
const GorhomPortalItem = props => {
  ...
  if ((0, import_constants.useIsomorphicLayoutEffect)(() => {
    ...
    import_constants2.portalListeners[props.hostName] ||= /* @__PURE__ */new Set(), import_constants2.portalListeners[props.hostName].add(listener);
  ...
  return actualNode ? (0, import_react_dom.createPortal)(/* @__PURE__ */(0, import_jsx_runtime.jsx)(import_web.TamaguiRoot, {
    theme,
