...
const isTeleportEnabled = () => {
    const state = (0, import_native.getPortal)().state;
    return state.enabled && state.type === "teleport";
  },
  needsPortalRepropagation = () => import_constants.isWeb || isTeleportEnabled() ? !1 : import_constants.isAndroid || import_constants.isIos,
