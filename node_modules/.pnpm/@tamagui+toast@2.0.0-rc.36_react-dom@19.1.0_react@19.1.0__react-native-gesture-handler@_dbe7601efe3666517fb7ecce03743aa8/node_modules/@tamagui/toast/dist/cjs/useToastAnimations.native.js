...
function useToastAnimations() {
  ...
  var {
    ...
    setDragOffset = (0, import_core.useEvent)(function (x, y) {
    ...
    springBack = (0, import_core.useEvent)(function (onComplete) {
      var _cancelAnimationRef_current;
    ...
    animateOut = (0, import_core.useEvent)(function (direction, velocity, onComplete) {
      var _cancelAnimationRef_current;
    ...
    stop = (0, import_core.useEvent)(function () {
      var _cancelAnimationRef_current;
